---------------------------------------------------------------------------
OpenHaptics(R) Academic Edition v3.0 Release (Build 66) Readme 7-Apr-2009
---------------------------------------------------------------------------
...
-------- 
    ...
    One of the supported devices from SensAble's PHANTOM(R) family of haptic devices.


Software
---------
  Windows(R) XP or XP x64 (SP2) or Vista or Vista 64


Compilers
---------
   Microsoft Visual Studio .NET 2003 or .NET 2005  
   Microsoft Visual Studio 2005 required for Windows x64 development


Drivers
---------
  PHANTOM Device Driver v 4.2.122 or later
...
Step 1: Uninstall previously installed PHANTOM Device Driver (PDD) and OpenHaptics
        software using the Add/Remove Programs icon in the control panel.
...
Step 4. Depending on your computer architecture, select either the win32 or x64
        folder. Install the device drivers by running the setup program in the
        “PHANTOM Device Drivers” folder. Make sure that you
        select the right type of device in the PHANTOM Configuration dialog (e.g.
...
Step 5. Install the OpenHaptics toolkit by running the setup program in the 
